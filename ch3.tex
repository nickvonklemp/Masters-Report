...
\end{equation}
\emph{\color{Gray}Here $\otimes$ represents the Hamilton product of two 3X3 matrices, it's elsewhere to indicate the quaternion multiplication operator.}
