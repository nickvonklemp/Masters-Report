...
\end{equation}
The final partial derivative to consider is that of the rotor's angular velocity $\vec{\Omega}_i$ but transformed into the inner ring frame $\mathcal{F}^{M_i'}$ which the Lagrangian in Eq:\ref{eq:sim-lagrange-inner} is taken with respect to:
