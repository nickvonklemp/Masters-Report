...
\end{figure}
\par
And as such, from classical Disc Actuator\cite{.} (\emph{momentum}) theory, the thrust acting on the fluid is a function of mass flow rate and change in velocity.
