...
\par
Unfortunately, short of performing physical flight tests, the model's response can only be regarded as a "best guess", such tests remain open to further research.
\par
...
\end{bmatrix}
\end{equation}
Running a simulation to test hover conditions won't provide any useful insight but it does, however, give a reasonable starting point.
\newpage
%====================================================
