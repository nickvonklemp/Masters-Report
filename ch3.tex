...
\end{equation}
Before continuing with a Lagrangian applied to the entire body it is worth first establishing a Lemma to add some clarity to the steps which follow. Consider the 
\par
