...
\end{equation}
\end{subequations}
Where the second term in Eq:\ref{eq:gimbal} represents an x-axis rotation in a new intermediate frame, post a 90\textdegree ~rotation in the y-axis. Through trigonometric double angles a degree of freedom is lost at $\theta=\pi$, when $\phi$ \& $\psi$ represent the same angle.
%====================================================
...
\end{equation}
\end{subequations}
Seeing that the vector component of a quaternion is a complex values, there then exists a quaternion conjugate property. Namely:
\begin{equation}
Q^*=\begin{bmatrix}
q_0 & -\vec{q}
\end{bmatrix}
