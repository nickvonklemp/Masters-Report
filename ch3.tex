...
\\
+\vec{\omega}_{b/I}^T\big(m_p\Big(\big(\Delta L_i \cdot \Delta L_i\big)\mathbb{I}_{3\times 3}-\Delta L_i \otimes \Delta L_i\Big)\big)\vec{\omega}_{b/I}-m_b\big(R_I^b(\eta)\vec{\mathcal{E}}+\Delta L_i\big)\cdot\vec{G}_b
\end{multline}
