...
\end{figure} 
\par
What is clear in a physical system is not necessarily as clear mathematically. An obvious loss of differentiability is present in the Euler Matrix $\Psi(\eta)$, Eq:\ref{eq:angular-rates.e} previously from Sec:\ref{subsec:proto.conventions.frames}. That relation between angular velocity, in the inertial frame or inversely in the body frame, and the angular rates of the Euler Angles in dependent on singular secant and tangential terms.
