...
\par
\emph{This dissertation report is presented in a logical progression of concepts and information. In some cases the research and results were completed in a different order from how they're listed.}
%---------------------------------------------------------------------
%	Acknowledgements
%---------------------------------------------------------------------
...
VTOL - Vetical Takeoff/Landing\\
OAT - Opposed Active Tilting\\
dOAT - Dual axist Opposed Active Tilting\\
PI - Proportional Integral, control strucutre\\
PD - Proportional Derivative, control structure\\
...
LCD - Lyupanov Candidate Function\\
PSO - Particle Swarm Optimization\\
ITAE - Integral Time Addative Error\\
...
\end{bmatrix}^T$
\\
Euler Rates: $\frac{d}{dt}\vec{\eta}=\dot{\vec{\eta}}=\Phi(\eta)\dot{\omega}_b$
\\
