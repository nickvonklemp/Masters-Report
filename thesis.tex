...
\newcommand{\subtitle}{Dynamic modelling and Control of Dual-Axis Tilting Quadrotor Aircraft}						% Thesis subtitle
...
\newcommand{\key}{Nonlinear Control, Control Allocation, Quadrotor, UAV}					   % Keywords (add logical keywords)
