...
\end{equation}
Knowing only $\vec{T}(\Omega_i)$ and $\vec{T}_i$ in the motor frame and body frame respectively requires solving for a quaternion which relates the two. If both vectors are of unit length, then the following relationship can be exploited:
\begin{equation}
...
=
\begin{bmatrix}
1+\vec{T}_i\cdot \vec{T}(\Omega_i)\\
-\vec{T}_i\times\vec{T}(\Omega_i)
\end{bmatrix}
\end{equation}
\end{subequations}
%====================================================
